...
int main(int argc,char **argv)
{
    ...
    if (show_tor)   cout<<"      Pm      Pp     O5m     O5p     C5m     C5p"
        ...
        <<"     O4m     O4p     O3m     O3p    P44p  C4114C    PppP";
    ...
    if (show_ang)   cout<<"     aPm     aPp    aO5m    aO5p    aC5m    aC5p"
        ...
        <<"    aO4m    aO4p    aO3m    aO3p     aPC     aCC   aPppP";
    cout<<endl;
