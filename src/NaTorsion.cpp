...
"        [6] pseudo torsion eta:    C4'[-1]-P-C4'-P[+1]\n"
"        [7] pseudo torsion theta:  P-C4'-P[+1]-C4'[+1]\n"
"        [8] pseudo torsion eta':   C1'[-1]-P-C1'-P[+1]\n"
"        [9] pseudo torsion theta': P-C1'-P[+1]-C1'[+1]\n"
"        [10]backbone torsion alpha:   O3'[-1]-P-O5'-C5'\n"
"        [11]backbone torsion beta:    P-O5'-C5'-C4'\n"
"        [12]backbone torsion gamma:   O5'-C5'-C4'-C3'\n"
"        [13]backbone torsion delta:   C5'-C4'-C3'-O3'\n"
"        [14]backbone torsion epsilon: C4'-C3'-O3'-P[+1]\n"
"        [15]backbone torsion zeta:    C3'-O3'-P[+1]-O5'[+1]\n"
"        [16]improper torsion i1:   C1'-P-C4'-P[+1]\n"
"        [17]sidechain torsion chi: O4'-C1'-N-C\n"
...
int main(int argc,char **argv)
{
    ...
    if (show_tor)   cout<<"      v0      v1      v2      v3      v4      v5"
        <<"     eta   theta    eta'  theta'   alpha    beta   gamma   delta"
        <<" epsilon    zeta      i1     chi";
