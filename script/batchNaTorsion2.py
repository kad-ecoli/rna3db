#!/usr/bin/env python
docstring='''
batchNaTorsion2.py ../cull/all_c1.0_s1.0/list.atomic ../cull/pdb_atom.sort.4.0_c0.8_s0.8 ../cull/all_c1.0_s1.0/
...
NaTorsion_exe=os.path.join(bindir,"NaTorsion2")
...
def batchNaTorsion(inputfasta,target_set,pdbfolder):
    ...
    for block in ('\n'+fp.read()).split('\n>'):
        ...
        txt+=stdout
    fp.close()
    fp=open("NaTorsion2.raw",'w')
    fp.write(txt)
    fp.close()
    os.system("gzip -f NaTorsion2.raw")
